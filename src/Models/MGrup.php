...
class MGrup extends Eloquent
{
    ...
    {
        return $this->hasMany('BangLipai\UserAkses\Models\GrupAkses', 'k_grup', 'k_grup');
    }
    ...
    {
        return $this->hasMany('BangLipai\UserAkses\Models\GrupAnggota', 'k_grup', 'k_grup');
    }
    ...
    {
        return $this->hasMany('BangLipai\UserAkses\Models\GrupAnggota', 'k_grup_anggota', 'k_grup');
    }
    ...
    {
        return $this->hasMany('BangLipai\UserAkses\Models\UserGrup', 'k_grup', 'k_grup');
    }
}
